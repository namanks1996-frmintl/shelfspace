              ...
              >
                ...
                <div className="flex flex-col gap-1 pt-1">
                  ...
                  <div className="flex flex-col gap-1 mt-1 mb-2 cursor-pointer" onClick={() => navigate(`/book/${book.id}`)}>
                     <h2 className="text-[18px] font-montagu font-medium uppercase leading-[1.2] line-clamp-2 tracking-normal text-white hover:text-purple-400 transition-colors">{book.title}</h2>
